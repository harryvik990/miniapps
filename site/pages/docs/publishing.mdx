...
:::warning
TODO Add an an advanced section discussing the nuances of choosing a domain for an
app.
:::
...
including the signature using the [Warpcast Farcaster JSON
Tool](https://warpcast.com/~/developers/domains). 

:::note
This tool is only supported on mobile. 
:::
...
Verify your Mini App using this tool:

TODO

TODO include snippet / full reference
...
Congratulations—your Mini App is now published! Next we'll cover how to make
your app sharable in feeds.

TODO
- clean up the domains tool on mobile
- add a placeholder on web
- preview / published flag in manifest
