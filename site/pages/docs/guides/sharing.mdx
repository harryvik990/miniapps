...
You can use the [Embed Debug Tool](https://warpcast.com/~/developers/apps/embed) in Warpcast to preview a embed.
...
Since embeds are shared feeds, they are generally scraped once and cached so
...
For example, we could create an embed that shows shows the current price of ETH. We'd
