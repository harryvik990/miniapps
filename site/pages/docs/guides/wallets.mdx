...
Mini Apps can interact with a user's crypto wallet without need to worry about
popping open "select your wallet" dialogs or flakey connections.
...
potentially malicious use this [Blockaid report tool
